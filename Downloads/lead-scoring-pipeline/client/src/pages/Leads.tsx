              ...
              <div className="flex gap-2">
                {selectedLead.sourceUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-neon-cyan/10 text-neon-cyan text-sm font-medium hover:bg-neon-cyan/20 transition-colors border border-neon-cyan/20"
                  >
                ...
                {selectedLead.profileUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-neon-blue/10 text-neon-blue text-sm font-medium hover:bg-neon-blue/20 transition-colors border border-neon-blue/20"
                  >
                    <ExternalLink className="w-4 h-4" />
                    View Profile
                  </a>
                ...
                {selectedLead.websiteUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-neon-purple/10 text-neon-purple text-sm font-medium hover:bg-neon-purple/20 transition-colors border border-neon-purple/20"
                  >
                    <ExternalLink className="w-4 h-4" />
                    Website
                  </a>
